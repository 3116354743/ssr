...
error_detect_depends(){
    ...
    if [ $? -ne 0 ]; then
        ...
        echo 'Please visit: https://www.r6b.cn/736.html and contact.'
        exit 1
    fi
}
...
install_prepare_password(){
    ...
    read -p '(Default password: 12345678):' shadowsockspwd
...
install_shadowsocks_python(){
    ...
    if [ -f /usr/bin/ssserver ] || [ -f /usr/local/bin/ssserver ]; then
        ...
        echo 'Please visit: https://www.r6b.cn/736.htmll and contact.'
        install_cleanup
        exit 1
    fi
}
...
install_main(){
    ...
    echo
    echo 'Welcome to visit: https://www.r6b.cn/736.html'
    echo 'Enjoy it!'
    echo
}
